...
def test_mask_account_card_for_cards(data, expected) -> None:
...
def test_mask_account_card_for_accounts(data, expected) -> None:
    assert mask_account_card(data) == expected
...
def test_mask_account_card_invalid_data(data)-> None:
