...
Принимать список словарей с данными о банковских операциях и список категорий
операций, а возвращать словарь, в котором ключи — это названия категорий,
а значения — это количество операций в каждой категории.

# Функция count_transaction_categories
Подсчет количества банковских операций по категориям

Написан тесты к функциям count_transaction_categories,
